...
photo_file1 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/cry.jpeg")
photo_file2 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/1975.jpeg")
photo_file3 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/darksun.jpeg")
photo_file4 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/dense.jpeg")
photo_file5 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/earth.jpg")
photo_file6 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/glitch.jpeg")
photo_file7 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/nyc.jpeg")
photo_file8 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/pink_sea.jpeg")
photo_file9 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/purple.png")
photo_file10 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/red.jpeg")
photo_file11 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/retro.jpeg")
photo_file12 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/trackImages/seaspan.jpeg")


audioFile1 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/What+remains+after+a+thunder+strike.mp3")
audioFile2 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-a-voice-from-the-past-548.mp3")
audioFile3 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-better-times-are-coming-173.mp3")

audioFile4 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-cbpd-400.mp3")
audioFile5 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-christmas-night-537.mp3")
audioFile6 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-deep-techno-ambience-134.mp3")
audioFile7 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-a-country-romance-36.mp3")
audioFile8 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-deep-urban-623.mp3")
audioFile9 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-house-vibes-129.mp3")
audioFile10 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-lonely-in-the-bar-518.mp3")
audioFile11 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-rock-the-game-49.mp3")
audioFile12 = open("https://sonar-seeds.s3.us-west-1.amazonaws.com/audioFiles/mixkit-love-in-the-air-41.mp3")
